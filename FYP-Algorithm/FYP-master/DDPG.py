...
class ActorNetwork(keras.Model):
    def __init__(
        ...
        self.mu = Dense(
            units=n_actions,
            activation=action_activation, # limit the action in the range [-1, 1] -> 'tanh', [0, 1] -> 'sigmoid'
            kernel_initializer=final_layer_initializer,
            bias_initializer=final_layer_initializer,
            name='action'
        )
...
class DDPGAgent:
    def __init__(
        ...
        self.actor  = ActorNetwork(name="actor", n_actions=n_actions, fc1_dims=actor_fc1, fc2_dims=actor_fc2, action_activation=self.action_activation)
        self.critic = CriticNetwork(name="critic", fc1_dims=critic_fc1, fc2_dims=critic_fc2)
        self.target_actor  = ActorNetwork(name="target_actor", n_actions=n_actions, fc1_dims=actor_fc1, fc2_dims=actor_fc2, action_activation=self.action_activation)
