...
class CriticNetwork(keras.Model):
    def __init__(
        ...
        self.state_normalizer = LayerNormalization(epsilon=10**-4, center=False, scale=False, name='state_normalizer')
        self.combining_normalizer = LayerNormalization(epsilon=10**-4, center=False, scale=False, name='combining normalizer')
...
class ActorNetwork(keras.Model):
    def __init__(
        ...
        self.state_normalizer = LayerNormalization(epsilon=10**-4, center=False, scale=False, name='state normalizer')
